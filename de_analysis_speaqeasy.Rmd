...
generate_plots <- function() {
    ...
    # PC1 vs. PC2
    plot(pca$x,
        pch = 21, bg = factor(rse_gene$PrimaryDx), cex = 1.2,
...
outGeneDupl <- topTable(ebGeneDupl,
    coef = 2,
...
sigGeneDupl <- topTable(ebGeneDupl,
    coef = 2,
...
# Do GO and KEGG
goBP_Adj <- compareCluster(sigGeneList,
    fun = "enrichGO",
...
goMF_Adj <- compareCluster(sigGeneList,
    fun = "enrichGO",
    universe = geneUniverse, OrgDb = org.Hs.eg.db,
...
goCC_Adj <- compareCluster(sigGeneList,
    fun = "enrichGO",
    universe = geneUniverse, OrgDb = org.Hs.eg.db,
...
kegg_Adj <- compareCluster(sigGeneList,
    fun = "enrichKEGG",
