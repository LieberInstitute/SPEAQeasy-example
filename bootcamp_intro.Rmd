...
You can download the [**latest version here**](https://github.com/LieberInstitute/SPEAQeasy-example/blob/master/bootcamp_intro.Rmd). ^[This was useful particularly during October 5-7 while I was updating this document frequently.]
...
gg_mito_vs_rRNA_rate <-
    ggplot(pd_key, aes(x = mitoRate, y = rRNA_rate, color = BrainRegion)) + geom_point()
