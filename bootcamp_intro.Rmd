...
In this particular case, the correlation we calculated wasn't useful, but in larger studies where we have more samples across individuals, it will be. 
...
## (normally we would look at the FDR < 0.5 genes or 0.1)
...
* Make a `heatplot()` using the results of enrichment analysis from the biological pathway study.
